    ...
    <table><?php
        if ($matchs == null) {
            ...
            foreach($matchs as $match) {
                if ($match[8] != 1) {
                    if ($match[4] == 1) {
                        ?><br><table><tr><th><input type="submit" id="correct" value="Chole <?php echo $match[1], " 1 - 0 ", $match[2], ' Paris: ', $match[3], ' Coups: ', $match[11]?>"></th></tr></table><?php
                    } else if ($match[4] == 2) {
                        ?><br><table><tr><th><input type="submit" id="correct" value="Déchole <?php echo $match[1], " 0 - 1 ", $match[2], ' Paris: ', $match[3], ' Coups: ', $match[11]?>"</th></tr></table><?php
