...
if ($_SESSION['connected']) {
    $req=$bdd->prepare("SELECT idmatch, attack, defend, score, goal FROM Match WHERE (score = 0) AND (attack=:equipeCap OR defend=:teamCap) ORDER BY(idmatch)");
    ...
    ?>
        ...
        <form action="../../Controller/Capitain/EnterScore.php" method="post">
    ...
    <?php
        ...
        <form action="../../Controller/Capitain/EnterScore.php" method="post">
            ...
            <input id="submit" type="submit" name="valider" value="valider">
            <input id="submit" type="submit" name="Contester" value="Contester">
