        ...
        ?><tr><th><?php echo "Parcours: ", $r[1]; if ($r[6] == 0) { echo " | Penalty";} else { echo " | Pari Max: ", $r[6];} ?></th><th>
            ...
            ?><form action="../../Controller/AdminFunctions/getMatch.php" method="post"><?php
                if ($match[8] == 1) {
                    ...
                    if ($match[4] == 1) {
                        ?><table><tr><th><?php echo $match[1] ?></th> <th><?php echo " Vainqueur de " ?></th><th><?php echo $match[2] ?></th> <th><?php echo "Pari: ", $match['3']?></th><th><?php echo " Coups déchôles: ", $match[11]?></th></tr></table><?php
                    } else if ($match[4] == 2) {
                        ?><table><tr><th><?php echo $match[1] ?></th> <th><?php echo " Perdant de " ?></th><th><?php echo $match[2] ?></th> <th><?php echo "Pari: ", $match['3']?></th><th><?php echo " Coups déchôles: ", $match[11]?></th></tr></table><?php
